                ...
                if (!empty($_FILES)) {
                    ...
                    if($_REQUEST['po_btn']){
                        ...
                        if($po_text == ""){
                            ...
                            $insert = "INSERT INTO 2_post (time,userid,pic,content) VALUES ('$time','$id','http://140.116.72.102/~legendd/final/wall/image/$visible','$_POST[po_text]')";
      ...
      <li>
       ...
       <form name="form2" action="" method="post" enctype="multipart/form-data">
          <?php
                ...
                if ($_FILES['small_photo']['tmp_name'] != "") {
