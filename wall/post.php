...
else
{
	...
	$insert = "INSERT INTO dogs (name,breed,year,month,gender,location,info,photo) VALUES('$_POST[nick]','$_POST[breed]','$_POST[year]','$_POST[month]','$_POST[gender]','$_POST[location]','$_POST[info]','http://140.116.72.102/~yuting/ex10/re-home/image/$here')";
	$res = mysqli_query($connect,$insert) or die('oh no!');
}


    echo "<embed src= 'http://140.116.72.102/~yuting/ex10/re-home/image/$here' /><br>";
